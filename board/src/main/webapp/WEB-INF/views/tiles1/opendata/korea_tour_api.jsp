...
<script type="text/javascript">
   ...
   function img_display(searchword, pageNo) {
	   ...
	   if(Number(pageNo) >= 1) {
           ...
           if(choice == "keyword"){
        	   url_address = "http://apis.data.go.kr/B551011/PhotoGalleryService1/gallerySearchList1?serviceKey=tJ7%2F7J0bJwUjU612xyVV8NCOk7Wt%2BkBWz8E4gkW6j3l5MG88Jru0MgRYOnZGvnIdxoXiYIYgZ%2BnnzaouzrWDRA%3D%3D&MobileOS=ETC&MobileApp=AppTest&_type=json&keyword="+encodeVal+"&numOfRows=20&pageNo="+pageNo;  
           }
           else if(choice == "title"){
        	   url_address = "http://apis.data.go.kr/B551011/PhotoGalleryService1/galleryDetailList1?serviceKey=tJ7%2F7J0bJwUjU612xyVV8NCOk7Wt%2BkBWz8E4gkW6j3l5MG88Jru0MgRYOnZGvnIdxoXiYIYgZ%2BnnzaouzrWDRA%3D%3D&MobileOS=ETC&MobileApp=AppTest&_type=json&title="+encodeVal+"&numOfRows=20&pageNo="+pageNo;   
           }
