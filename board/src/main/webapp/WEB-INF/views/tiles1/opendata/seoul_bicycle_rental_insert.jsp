            ...
            if(json.length == 0){
               ...
               let v_html = `<table class="table table-bordered table-striped table-sm">
                    ...
                    Highcharts.chart('bar_chart_container', {
                        ...
                        subtitle: {
                            text: 'Source: <a href="https://data.seoul.go.kr/dataList/OA-21235/S/1/datasetView.do" target="_blank">서울시 따릉이대여소 마스터 정보</a>'
                        },
                        xAxis: {
                            type: 'category',
                            labels: {
            ...
            success:function(json){
               ...
               // console.log(JSON.stringify(json));
                   ...
                   $.each(json, function(index, item){
                     ...
                     alert("데이터 입력건수 totalCnt : " + totalCnt); // 대략 25초 정도 소요됨      
                   // 데이터 입력건수 totalCnt :  
            },
            error: function(request, status, error){
                   alert("code: "+request.status+"\n"+"message: "+request.responseText+"\n"+"error: "+error);
