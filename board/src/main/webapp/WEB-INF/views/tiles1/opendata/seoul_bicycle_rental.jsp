...
<div align="center">
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=bfbab21d7b312da5273c7b2b3cb76d20"></script> 
    	        ...
    	        success:function(json){
    	         ...
    	         $.each(json, function(index, item){
    	            ...
    	            position.content = "<div class='mycontent'>"+
    	                           ...
    	                           "</div>";   
    	            <%-- content 는 키값, "<div></div>" 는 밸류값 이런 형식 --%>
    	            position.latlng = new kakao.maps.LatLng(item.statn_lat, item.statn_lnt);   
    	            // item 은 위 주석에 {} 한개, .lat 거기서 요소값
    	            
    	            positionArr.push(position);   // 배열에 넣어준다.
    	   ...
    	   // infowindowArr 은 인포윈도우를 가지고 있는 객체 배열의 용도이다. 
    	    ...
    	    for(let i=0; i<positionArr.length; i++){
    	       ...
    	       // 지도에 마커를 표시한다.
    	        ...
    	        // == 마커 위에 인포윈도우를 표시하기 (잘못된거) == //
    	        // infowindow.open(mapobj, marker); 
    	        
    	        
    	        // == 마커 위에 인포윈도우를 표시하기 (kakao 에서 제공) == //
